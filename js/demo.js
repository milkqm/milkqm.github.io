...
Tunnel.prototype.createMesh = function(texture) {
    ...
    this.tubeMaterial.map.repeat.set(this.tubeMaterial.repx,
...
Tunnel.prototype.initAnimation = function() {
    ...
    var self = this;
    var hyperSpace = new TimelineMax({
        repeat : -1
    });
...
Tunnel.prototype.updateMaterialOffset = function() {
    ...
    this.tubeMaterial.map.repeat.set(this.textureParams.repeatX,
